...
def load_selective_processing_config(csv_path='report_wrong.csv'):
...
def run_ocr_by_year_selective(year: int, selective_config: dict, min_filename=None):
    """
...
for year in sorted(years_to_process):
    ...
    run_ocr_by_year_selective(year, selective_config)
    print(f"Completed selective processing for {year}")
